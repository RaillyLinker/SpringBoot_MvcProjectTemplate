...
class SwaggerConfig {
    ...
    private val documentDescription: String = """
      ...
      **(Rest API Response Header 의 API 결과 표시 규칙)**
        ...
        - api-result-code 의 발생 순서는 아래와 같습니다.
        
            1. ok 는 무조건 다른 모든 api-result-code 분기의 마지막에 나옵니다.
            
            2. API 별 숫자 api-result-code 는 숫자가 작을수록 먼저 검사를 합니다.
            
                예를들어 api-result-code 1 번이 "가입하려는 회원 정보가 이미 존재",
