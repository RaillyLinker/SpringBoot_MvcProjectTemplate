...
import com.railly_linker.springboot_mvc_project_template.data_sources.network_retrofit2.request_apis.AppleIdAppleComRequestApi
...
object AppleOAuthHelperUtilObject {
    ...
    fun getAppleMemberData(idToken: String): AppleProfileData? {
        try {
            ...
            val memberInfo: Claims = Jwts.parserBuilder().setSigningKey(publicKey).build().parseClaimsJws(idToken).body
