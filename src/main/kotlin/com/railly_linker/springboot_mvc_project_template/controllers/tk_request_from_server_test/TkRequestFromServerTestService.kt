...
class TkRequestFromServerTestService(
    ...
    fun api8(httpServletResponse: HttpServletResponse): TkRequestFromServerTestController.Api8OutputVo? {
        ...
        // 전송 하려는 File
        val serverFile =
            Paths.get("${File("").absolutePath}/src/main/resources/static/tk_request_from_server_test_api8/test.txt")
                .toFile()
    ...
    fun api9(httpServletResponse: HttpServletResponse): TkRequestFromServerTestController.Api9OutputVo? {
        ...
        // 전송 하려는 File
        val serverFile1 =
            Paths.get("${File("").absolutePath}/src/main/resources/static/tk_request_from_server_test_api9/test1.txt")
                .toFile()
        val serverFile2 =
            Paths.get("${File("").absolutePath}/src/main/resources/static/tk_request_from_server_test_api9/test2.txt")
                .toFile()
    ...
    fun api10(httpServletResponse: HttpServletResponse): TkRequestFromServerTestController.Api10OutputVo? {
        ...
        // 전송 하려는 File
        val serverFile =
            Paths.get("${File("").absolutePath}/src/main/resources/static/tk_request_from_server_test_api10/test.txt")
                .toFile()
        val multipartFileFormData = MultipartBody.Part.createFormData(
            "multipartFile",
            serverFile.name,
