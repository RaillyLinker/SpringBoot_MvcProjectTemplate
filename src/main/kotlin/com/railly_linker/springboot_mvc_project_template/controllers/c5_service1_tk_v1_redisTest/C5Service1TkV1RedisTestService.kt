...
@Service
class C5Service1TkV1RedisTestService(
    ...
    fun api1(
        ...
        inputVo: C5Service1TkV1RedisTestController.Api1InputVo
    ) {
    ...
    ////
    fun api2(httpServletResponse: HttpServletResponse, key: String): C5Service1TkV1RedisTestController.Api2OutputVo? {
        // 전체 조회 테스트
        ...
        httpServletResponse.setHeader("api-result-code", "0")
        return C5Service1TkV1RedisTestController.Api2OutputVo(
    ...
    ////
    fun api3(httpServletResponse: HttpServletResponse): C5Service1TkV1RedisTestController.Api3OutputVo? {
        // 전체 조회 테스트
        val keyValueList = redis1TestRepository.findAllKeyValues()

        val testEntityListVoList = ArrayList<C5Service1TkV1RedisTestController.Api3OutputVo.KeyValueVo>()
        for (keyValue in keyValueList) {
            testEntityListVoList.add(
                C5Service1TkV1RedisTestController.Api3OutputVo.KeyValueVo(
                    keyValue.key,
                    keyValue.value.content,
                    keyValue.expireTimeMs
                )
        ...
        httpServletResponse.setHeader("api-result-code", "0")
        return C5Service1TkV1RedisTestController.Api3OutputVo(
            Redis1_Test.TABLE_NAME,
    ...
    fun api6(httpServletResponse: HttpServletResponse, inputVo: C5Service1TkV1RedisTestController.Api6InputVo) {
        redis1TestRepository.saveKeyValue(
            inputVo.key,
            Redis1_Test(
                inputVo.content,
    ...
    ////
    fun api7(httpServletResponse: HttpServletResponse, inputVo: C5Service1TkV1RedisTestController.Api7InputVo) {
        redis1TestRepository.saveKeyValue(
            inputVo.key,
            Redis1_Test(
                inputVo.content,
