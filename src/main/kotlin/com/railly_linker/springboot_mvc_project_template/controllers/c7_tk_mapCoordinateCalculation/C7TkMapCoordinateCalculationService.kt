package com.railly_linker.springboot_mvc_project_template.controllers.c7_tk_mapCoordinateCalculation
...
import com.railly_linker.springboot_mvc_project_template.util_objects.MapCoordinateUtilObject
...
@Service
class C7TkMapCoordinateCalculationService(
    ...
    fun api2(
        httpServletResponse: HttpServletResponse,
        inputVo: C7TkMapCoordinateCalculationController.Api2InputVo
    ): C7TkMapCoordinateCalculationController.Api2OutputVo? {
    ...
    fun api3(
        httpServletResponse: HttpServletResponse,
        inputVo: C7TkMapCoordinateCalculationController.Api3InputVo
    ): C7TkMapCoordinateCalculationController.Api3OutputVo? {
        database1TemplateTestMapRepository.save(
            Database1_Template_TestMap(
                inputVo.latitude,
                inputVo.longitude,
        ...
        val coordinateList = ArrayList<C7TkMapCoordinateCalculationController.Api3OutputVo.Coordinate>()
        val latLngCoordinate = ArrayList<Pair<Double, Double>>()

        for (testMap in database1TemplateTestMapRepository.findAll()) {
            coordinateList.add(
                C7TkMapCoordinateCalculationController.Api3OutputVo.Coordinate(
                    testMap.latitude,
                    testMap.longitude
                )
            )
    ...
    fun api5(
    ...
    ): C7TkMapCoordinateCalculationController.Api5OutputVo? {
        val entityList =
        ...
        val coordinateCalcResultList = ArrayList<C7TkMapCoordinateCalculationController.Api5OutputVo.CoordinateCalcResult>()
        for (entity in entityList) {
            coordinateCalcResultList.add(
                C7TkMapCoordinateCalculationController.Api5OutputVo.CoordinateCalcResult(
                    entity.uid,
                    entity.latitude,
                    entity.longitude,
    ...
    fun api6(
    ...
    ): C7TkMapCoordinateCalculationController.Api6OutputVo? {
        val entityList =
        ...
        val coordinateCalcResultList = ArrayList<C7TkMapCoordinateCalculationController.Api6OutputVo.CoordinateCalcResult>()
        for (entity in entityList) {
            coordinateCalcResultList.add(
                C7TkMapCoordinateCalculationController.Api6OutputVo.CoordinateCalcResult(
                    entity.uid,
                    entity.latitude,
                    entity.longitude
                )
