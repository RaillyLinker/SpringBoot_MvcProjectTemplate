package com.railly_linker.springboot_mvc_project_template.controllers.c3_service1_tk_v1_requestTest
...
@Service
class C3Service1TkV1RequestTestService(
    ...
    ): C3Service1TkV1RequestTestController.Api4OutputVo? {
        httpServletResponse.setHeader("api-result-code", "0")
        return C3Service1TkV1RequestTestController.Api4OutputVo(
            queryParamString,
    ...
    fun api5(
        httpServletResponse: HttpServletResponse,
        pathParamInt: Int
    ): C3Service1TkV1RequestTestController.Api5OutputVo? {
        httpServletResponse.setHeader("api-result-code", "0")
        return C3Service1TkV1RequestTestController.Api5OutputVo(pathParamInt)
    }
    ...
    fun api6(
        httpServletResponse: HttpServletResponse,
        inputVo: C3Service1TkV1RequestTestController.Api6InputVo
    ): C3Service1TkV1RequestTestController.Api6OutputVo? {
        httpServletResponse.setHeader("api-result-code", "0")
        return C3Service1TkV1RequestTestController.Api6OutputVo(
    ...
    fun api7(
        httpServletResponse: HttpServletResponse,
        inputVo: C3Service1TkV1RequestTestController.Api7InputVo
    ): C3Service1TkV1RequestTestController.Api7OutputVo? {
        httpServletResponse.setHeader("api-result-code", "0")
        return C3Service1TkV1RequestTestController.Api7OutputVo(
    ...
    fun api8(
        httpServletResponse: HttpServletResponse,
        inputVo: C3Service1TkV1RequestTestController.Api8InputVo
    ): C3Service1TkV1RequestTestController.Api8OutputVo? {
        // 파일 저장 기본 디렉토리 경로
        ...
        httpServletResponse.setHeader("api-result-code", "0")
        return C3Service1TkV1RequestTestController.Api8OutputVo(
            inputVo.requestFormString,
            inputVo.requestFormStringNullable,
            inputVo.requestFormInt,
            inputVo.requestFormIntNullable,
    ...
    fun api9(
        httpServletResponse: HttpServletResponse,
        inputVo: C3Service1TkV1RequestTestController.Api9InputVo
    ): C3Service1TkV1RequestTestController.Api9OutputVo? {
        // 파일 저장 기본 디렉토리 경로
        val saveDirectoryPath: Path = Paths.get("./files/temp").toAbsolutePath().normalize()
        ...
        httpServletResponse.setHeader("api-result-code", "0")
        return C3Service1TkV1RequestTestController.Api9OutputVo(
            inputVo.requestFormString,
            inputVo.requestFormStringNullable,
            inputVo.requestFormInt,
            inputVo.requestFormIntNullable,
    ...
    fun api10(
        httpServletResponse: HttpServletResponse,
        inputVo: C3Service1TkV1RequestTestController.Api10InputVo
    ): C3Service1TkV1RequestTestController.Api10OutputVo? {
        ...
        httpServletResponse.setHeader("api-result-code", "0")
        return C3Service1TkV1RequestTestController.Api10OutputVo(
    ...
    fun api12(
        httpServletResponse: HttpServletResponse,
        errorType: C3Service1TkV1RequestTestController.Api12ErrorTypeEnum?
    ) {
        if (errorType == null) {
            httpServletResponse.setHeader("api-result-code", "0")
        } else {
    ...
    ////
    fun api17(
        videoHeight: C3Service1TkV1RequestTestController.Api17VideoHeight,
        httpServletResponse: HttpServletResponse
    ): Resource? {
        ...
        val serverFileNameString =
            when (videoHeight) {
                C3Service1TkV1RequestTestController.Api17VideoHeight.H240 -> {
                    "test_240p.mp4"
                }

                C3Service1TkV1RequestTestController.Api17VideoHeight.H360 -> {
                    "test_360p.mp4"
                }

                C3Service1TkV1RequestTestController.Api17VideoHeight.H480 -> {
                    "test_480p.mp4"
                }

                C3Service1TkV1RequestTestController.Api17VideoHeight.H720 -> {
                    "test_720p.mp4"
                }
            }
    ...
    ////
    fun api19(httpServletResponse: HttpServletResponse): DeferredResult<C3Service1TkV1RequestTestController.Api19OutputVo>? {
        // 연결 타임아웃 밀리초
        val deferredResultTimeoutMs = 1000L * 60
        val deferredResult = DeferredResult<C3Service1TkV1RequestTestController.Api19OutputVo>(deferredResultTimeoutMs)
        ...
        executorService.execute {
            ...
            // 결과 반환
            deferredResult.setResult(C3Service1TkV1RequestTestController.Api19OutputVo("${delayMs / 1000} 초 경과 후 반환했습니다."))
        }
