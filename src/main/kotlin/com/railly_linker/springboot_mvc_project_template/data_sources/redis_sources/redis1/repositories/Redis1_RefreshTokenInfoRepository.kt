...
@Component
class Redis1_RefreshTokenInfoRepository(
    ...
    fun findAllKeyValues(): List<KeyValueData> {
        ...
        for (innerKey in keySet) {
            ...
            val valueObject = Gson().fromJson<Redis1_RefreshTokenInfo>(
                innerValue as String, // 해석하려는 json 형식의 String
                object : TypeToken<Redis1_RefreshTokenInfo>() {}.type // 파싱할 데이터 스키마 객체 타입
            )
    ...
    data class KeyValueData(
        ...
        val value: Redis1_RefreshTokenInfo,
