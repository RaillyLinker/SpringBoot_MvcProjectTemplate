...
@Entity
@Table(name = "join_the_membership_with_phone_number_verification_data", catalog = "member")
@Comment("이메일 회원가입 검증 테이블")
class Database1_Member_JoinTheMembershipWithPhoneNumberVerificationData(
